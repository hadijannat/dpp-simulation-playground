...
from .v1 import catalog, negotiations, transfers, policies, participants, health, assets, webhooks

api_router = APIRouter()
api_router.include_router(health.router, prefix="/api/v1")
api_router.include_router(catalog.router, prefix="/api/v1/edc")
api_router.include_router(assets.router, prefix="/api/v1/edc")
...
api_router.include_router(webhooks.router, prefix="/api/v1/edc")
